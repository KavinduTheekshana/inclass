...
<head>
    ...
    <!-- Perfect Scrollbar -->
    <link href="{{ URL::asset('assets/vendor/perfect-scrollbar.css') }}" rel="stylesheet">
    <!-- <link type="text/css" href="assets/vendor/perfect-scrollbar.css" rel="stylesheet"> -->

    <!-- Material Design Icons -->
    <link href="{{ URL::asset('assets/css/material-icons.css') }}" rel="stylesheet">
    ...
    <!-- Preloader -->
    <!-- <link href="{{ URL::asset('assets/vendor/spinkit.css') }}" rel="stylesheet"> -->
    <!-- <link href="{{ URL::asset('assets/css/preloader.css') }}" rel="stylesheet"> -->
    ...
    <link href="{{ URL::asset('assets/css/dark-mode.css') }}" rel="stylesheet">
                ...
                <div class="nav navbar-nav flex-nowrap d-flex ml-0 mr-16pt">
                    <div class="nav-item dropdown d-none d-sm-flex">
                        <a href="#" class="nav-link d-flex align-items-center dropdown-toggle" data-toggle="dropdown">
                            <img width="40" height="40" class="rounded-circle mr-8pt" src="{{ Auth::user()->profile_photo_url }}" alt="{{ Auth::user()->name }}" />
                            <span class="flex d-flex flex-column mr-8pt">
                                <span class="navbar-text-100">{{ Auth::user()->name }}</span>
                                <small class="navbar-text-50">
            ...
            <div class="js-fix-footer footer border-top-2">
                <div class="container-fluid page__container page-section d-flex flex-column">
                    ...
                    <p class="measure-lead-max text-muted mb-0 small">Huma is a beautifully crafted user interface for
                        ...
                        Relationship Management, Enterprise Resource Planning, Human Resources, Content Management
                        System, Project Management, Tasks, eCommerce, Messaging and Account Management.</p>
                </div>
        ...
        <div class="mdk-drawer js-mdk-drawer" id="default-drawer">
            <div class="mdk-drawer__content">
                <div class="sidebar sidebar-dark sidebar-left" data-perfect-scrollbar>
                    ...
                    <!-- Navbar toggler -->
                    <!-- <a href="compact-hr-dashboard.html" class="navbar-toggler navbar-toggler-right navbar-toggler-custom d-flex align-items-center justify-content-center position-absolute right-0 top-0" data-toggle="tooltip" data-title="Switch to Compact Vertical Layout" data-placement="right" data-boundary="window">
                    ...
                    <div class="sidebar-account mx-16pt mb-16pt dropdown">
                        <a href="#" class="nav-link d-flex align-items-center dropdown-toggle" data-toggle="dropdown" data-caret="false">
                            <img width="32" height="32" class="rounded-circle mr-8pt" src="{{ Auth::user()->profile_photo_url }}" alt="{{ Auth::user()->name }}" />
                            <span class="flex d-flex flex-column mr-8pt">
                                <span class="text-black-100">{{ Auth::user()->name }}</span>
                                <small class="text-black-50"> @if( Auth::user()->type =='ADMIN')
                                    Administrator
                                    @elseif( Auth::user()->type =='EDITOR')
                                    Teacher
                                    @elseif( Auth::user()->type =='STUDENTS')
                    ...
                    <form action="index.html" class="search-form flex-shrink-0 search-form--black sidebar-m-b sidebar-p-l mx-16pt pr-0">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="sidebar-menu-item">
                            <a class="sidebar-menu-button" href="add_students">
                        ...
                        <li class="sidebar-menu-item">
                            ...
                            <ul class="sidebar-submenu collapse sm-indent" id="dashboards_menu">
                                ...
                                <li class="sidebar-menu-item">
                                    <a class="sidebar-menu-button disabled" href="ui-card-metrics.html">
    ...
    <span class="sidebar-menu-text">Chips</span>
                        ...
                        <li class="sidebar-menu-item">
                            ...
                            <ul class="sidebar-submenu collapse sm-indent" id="layouts_menu">
                                ...
                                <li class="sidebar-menu-item">
                                    <a class="sidebar-menu-button" href="mini-hr-dashboard.html">
                                ...
                                <li class="sidebar-menu-item">
                                    <a class="sidebar-menu-button" href="boxed-hr-dashboard.html">
                                        <span class="sidebar-menu-text">Boxed</span>
                                    </a>
                                </li>
                                <li class="sidebar-menu-item">
                                    <a class="sidebar-menu-button" href="sticky-hr-dashboard.html">
...
<div id="app-settings">
    <app-settings layout-active="app" :layout-location="{
      'compact': 'compact-hr-dashboard.html',
      'mini': 'mini-hr-dashboard.html',
      'app': 'hr-dashboard.html',
      <!-- 'boxed': 'boxed-hr-dashboard.html', -->
      'sticky': 'sticky-hr-dashboard.html',
      'default': 'fixed-hr-dashboard.html'
    }" sidebar-type="light" sidebar-variant="bg-body"></app-settings>
</div>
<!-- jQuery -->
<script type="text/javascript" src="{{ URL::asset('assets/vendor/jquery.min.js') }}"></script>
<!-- <link href="{{ URL::asset('assets/vendor/jquery.min.js') }}" rel="script"> -->
<!-- <script src="assets/vendor/jquery.min.js"></script> -->

<!-- Bootstrap -->
<script type="text/javascript" src="{{ URL::asset('assets/vendor/popper.min.js') }}"></script>
<script type="text/javascript" src="{{ URL::asset('assets/vendor/bootstrap.min.js') }}"></script>
<!-- <link href="{{ URL::asset('assets/vendor/popper.min.js') }}" rel="script"> -->
<!-- <link href="{{ URL::asset('assets/vendor/bootstrap.min.js') }}" rel="script"> -->
<!-- <script src="assets/vendor/popper.min.js"></script> -->
<!-- <script src="assets/vendor/bootstrap.min.js"></script> -->

<!-- Perfect Scrollbar -->
<script type="text/javascript" src="{{ URL::asset('ssets/vendor/perfect-scrollbar.min.js') }}"></script>
<!-- <link href="{{ URL::asset('assets/vendor/perfect-scrollbar.min.js') }}" rel="script"> -->
<!-- <script src="assets/vendor/perfect-scrollbar.min.js"></script> -->

<!-- DOM Factory -->
<script type="text/javascript" src="{{ URL::asset('assets/vendor/dom-factory.js') }}"></script>
<!-- <link href="{{ URL::asset('assets/vendor/dom-factory.js') }}" rel="script"> -->
<!-- <script src="assets/vendor/dom-factory.js"></script> -->

<!-- MDK -->
<script type="text/javascript" src="{{ URL::asset('assets/vendor/material-design-kit.js') }}"></script>
<!-- <link href="{{ URL::asset('assets/vendor/material-design-kit.js') }}" rel="script"> -->
<!-- <script src="assets/vendor/material-design-kit.js"></script> -->

<!-- App JS -->
<script type="text/javascript" src="{{ URL::asset('assets/js/app.js') }}"></script>
<!-- <link href="{{ URL::asset('assets/js/app.js') }}" rel="script"> -->
<!-- <script src="assets/js/app.js"></script> -->

<!-- Highlight.js -->
<script type="text/javascript" src="{{ URL::asset('assets/js/hljs.js') }}"></script>
<!-- <link href="{{ URL::asset('assets/js/hljs.js') }}" rel="script"> -->
<!-- <script src="assets/js/hljs.js"></script> -->

<!-- Global Settings -->
<script type="text/javascript" src="{{ URL::asset('assets/js/settings.js') }}"></script>
<!-- <link href="{{ URL::asset('assets/js/settings.js') }}" rel="script"> -->
<!-- <script src="assets/js/settings.js"></script> -->

<!-- Moment.js -->
<script type="text/javascript" src="{{ URL::asset('assets/vendor/moment.min.js') }}"></script>
<script type="text/javascript" src="{{ URL::asset('assets/vendor/moment-range.js') }}"></script>
<!-- <link href="{{ URL::asset('assets/vendor/moment.min.js') }}" rel="script"> -->
<!-- <link href="{{ URL::asset('assets/vendor/moment-range.js') }}" rel="script"> -->
<!-- <script src="assets/vendor/moment.min.js"></script> -->
<!-- <script src="assets/vendor/moment-range.js"></script> -->

<!-- Flatpickr -->
<script type="text/javascript" src="{{ URL::asset('assets/vendor/flatpickr/flatpickr.min.js') }}"></script>
<script type="text/javascript" src="{{ URL::asset('assets/js/flatpickr.js') }}"></script>
<!-- <link href="{{ URL::asset('assets/vendor/flatpickr/flatpickr.min.js') }}" rel="script"> -->
<!-- <link href="{{ URL::asset('assets/js/flatpickr.js') }}" rel="script"> -->
<!-- <script src="assets/vendor/flatpickr/flatpickr.min.js"></script> -->
<!-- <script src="assets/js/flatpickr.js"></script> -->

<!-- Chart.js -->
<script type="text/javascript" src="{{ URL::asset('assets/vendor/Chart.min.js') }}"></script>
<script type="text/javascript" src="{{ URL::asset('assets/js/chartjs.js') }}"></script>
<!-- <link href="{{ URL::asset('assets/vendor/Chart.min.js') }}" rel="script"> -->
<!-- <link href="{{ URL::asset('assets/js/chartjs.js') }}" rel="script"> -->
<!-- <script src="assets/vendor/Chart.min.js"></script> -->
<!-- <script src="assets/js/chartjs.js"></script> -->

<!-- Chart.js Samples -->
<script type="text/javascript" src="{{ URL::asset('assets/js/page.hr-dashboard.js') }}"></script>
<!-- <link href="{{ URL::asset('assets/js/page.hr-dashboard.js') }}" rel="script"> -->
<!-- <script src="assets/js/page.hr-dashboard.js"></script> -->

<!-- List.js -->
<script type="text/javascript" src="{{ URL::asset('assets/vendor/list.min.js') }}"></script>
<script type="text/javascript" src="{{ URL::asset('assets/js/list.js') }}"></script>
<!-- <link href="{{ URL::asset('assets/vendor/list.min.js') }}" rel="script"> -->
<!-- <link href="{{ URL::asset('assets/js/list.js') }}" rel="script"> -->
<!-- <script src="assets/vendor/list.min.js"></script> -->
<!-- <script src="assets/js/list.js"></script> -->

<!-- Tables -->
<script type="text/javascript" src="{{ URL::asset('assets/js/toggle-check-all.js') }}"></script>
<script type="text/javascript" src="{{ URL::asset('assets/js/check-selected-row.js') }}"></script>
<!-- <link href="{{ URL::asset('assets/js/toggle-check-all.js') }}" rel="script"> -->
<!-- <link href="{{ URL::asset('assets/js/check-selected-row.js') }}" rel="script"> -->
<!-- <script src="assets/js/toggle-check-all.js"></script> -->
<!-- <script src="assets/js/check-selected-row.js"></script> -->

<!-- App Settings (safe to remove) -->
<script type="text/javascript" src="{{ URL::asset('assets/js/app-settings.js') }}"></script>
<!-- <link href="{{ URL::asset('assets/js/app-settings.js') }}" rel="script"> -->
